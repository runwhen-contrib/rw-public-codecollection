...
## Codebundle Index
| Folder Name | Type | Path | Documentation | Use-Cases |
|---|---|---|---|---|
...
| k8s-kubectl-get | SLI | [sli.robot](./codebundles/k8s-kubectl-get/sli.robot) |        This codebundle runs a kubectl get command that produces a value and pushes the metric. | Use Case: SLI: Query all Certificates that are **NOT** "Ready" in a namespace<br>
Use Case: SLI: Sum, up all container restarts in a namespace<br>
Use Case: SLI: Count all Flux HelmReleases that are **NOT** "Ready"<br>
Use Case: SLI: Count all Kubernetes API Services<br>
Use Case: SLI: Count all Kubernetes API Services that are **NOT** "Ready"<br> |
