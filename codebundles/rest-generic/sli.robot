...
Suite Initialization
    ...
    ...    type=string
    ...    description=A json string of headers to include in the request against the REST endpoint. This can include your token.
    ...    pattern=\w*
    ...    default='{}'
    ...
    ...    type=string
    ...    description=HTTP URL query parameters to use during the request.
    ...    pattern=\w*
    ...    example={"mygetparam":1}
    ...    default={"mygetparam":1}
    ${JSON_DATA}=    RW.Core.Import User Variable    JSON_DATA
    ...    type=string
    ...    description=Json data to include in the body of the request.
    ...    pattern=\w*
