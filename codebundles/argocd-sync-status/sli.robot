...
Documentation     Check the sync status of applications managed by ArgoCD
...
Inspect Applications
    ...
    RW.Core.Import User Variable    SYNC_STATUS
    ...    type=string
    ...    description=The ArgoCD Application sync status
    ...    example=Synced
    ...    default=Synced
